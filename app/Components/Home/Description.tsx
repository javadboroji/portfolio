        ...
        <Col xs={22} lg={12} >
            <div className='flex flex-col items-center flex-col mx-4'>
                ...
                <p className=' dark:text-white text-black font-medium text-base text-right leading-9 ml-4 '>
                    ...
                    <span className='font-bold'>      تحصیلات و توانمندی‌های تخصصی<br /></span>
                    ...
                    <span className='font-bold'>      مشتاق به یادگیری و به‌روزرسانی<br /></span>
                    ...
                    <span className='font-bold'> تجربه های کاری من</span>
