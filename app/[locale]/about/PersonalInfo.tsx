...
async function PersonalInfo() {
  ...
  return (
    <Col xs={24} lg={10}>
      <span className="text-3xl dark:text-white w-full block">
        {" "}
        {t("PersonalInformationTitle")}
      </span>
      <div className="flex flex-wrap mt-8">
        <div className="flex-col lg:flex w-full mb-6">
          <div className="dark:text-gray-400 text-xl mb-3 lg:mb-0  w-full lg:w-1/2">
            {" "}
            {t("firstNameTitle")}:{" "}
            <span className="dark:text-white"> {aboutRes.name}</span>
          </div>
          <div className="dark:text-gray-400  text-xl  w-full lg:w-1/2">
            {" "}
            {t("lastNameTitle")} :
            <span className="dark:text-white"> {aboutRes.lastName}</span>
          </div>
        </div>
        <div className="flex-col lg:flex w-full mb-6">
        ...
        <div className="flex-col lg:flex w-full mb-6">
          ...
          <div className="dark:text-gray-400  text-xl w-1/2">
            {" "}
            {t("languageTitle")}:
            <span className="dark:text-white"> {aboutRes.language}</span>
          </div>
        </div>
      </div>
    </Col>
